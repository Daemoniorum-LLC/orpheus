...
import type { Note } from '@maestro-ai/music-theory';
import type { MidiNote } from '@maestro-ai/shared-types';
import { fromMidiNote, getMidiNote } from '@maestro-ai/music-theory';
