...
import { saveProjectToBrowserDownload } from '@maestro-ai/project-model';
 ...
 */
const AUTOSAVE_KEY = 'maestro-autosave';
const AUTOSAVE_TIMESTAMP_KEY = 'maestro-autosave-timestamp';
