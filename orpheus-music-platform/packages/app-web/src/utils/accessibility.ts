...
export function createSkipLink(targetId: string, label: string = 'Skip to main content'): void {
  ...
  // Show on focus - use theme-aware colors via CSS custom properties
  skipLink.addEventListener('focus', () => {
    ...
    skipLink.style.backgroundColor = 'hsl(var(--primary))';
    skipLink.style.color = 'hsl(var(--primary-foreground))';
    skipLink.style.textDecoration = 'none';
    skipLink.style.zIndex = '10000';
    skipLink.style.borderRadius = '6px';
    skipLink.style.fontWeight = '500';
    skipLink.style.boxShadow = '0 4px 12px rgba(0, 0, 0, 0.15)';
  });
